...
public class FormularioAgregarProveedor extends JFrame {
	...
	public FormularioAgregarProveedor() {
		...
		lblNombre.setFont(new Font(FONT_NAME_T, Font.PLAIN, 20));
		lblNombre.setBounds(32, 31, 81, 32);
		contentPane.add(lblNombre);
		
		JLabel lblMarca = new JLabel("Marca");
		lblMarca.setFont(new Font(FONT_NAME_T, Font.PLAIN, 20));
		lblMarca.setBounds(32, 74, 81, 32);
		contentPane.add(lblMarca);
		
		JLabel lblTelefono = new JLabel("Telefono");
		lblTelefono.setFont(new Font(FONT_NAME_T, Font.PLAIN, 20));
		lblTelefono.setBounds(32, 117, 81, 32);
		contentPane.add(lblTelefono);
		
		JLabel lblCorreo = new JLabel("Correo");
		lblCorreo.setFont(new Font(FONT_NAME_T, Font.PLAIN, 20));
		lblCorreo.setBounds(32, 160, 81, 32);
		contentPane.add(lblCorreo);
		
		textNombre = new JTextField();
		textNombre.setToolTipText("Agrega el nombre y apellido\r\n");
		textNombre.setFont(new Font(FONT_NAME_T, Font.PLAIN, 18));
		textNombre.setBounds(132, 33, 255, 31);
		contentPane.add(textNombre);
		textNombre.setColumns(10);
		
		textMarca = new JTextField();
		textMarca.setFont(new Font(FONT_NAME_T, Font.PLAIN, 18));
		...
		textTelefono.setFont(new Font(FONT_NAME_T, Font.PLAIN, 18));
		...
		textCorreo.setFont(new Font(FONT_NAME_T, Font.PLAIN, 18));
		...
		btnAgregar.setFont(new Font(FONT_NAME_T, Font.BOLD, 18));
		btnAgregar.setBounds(85, 226, 120, 70);
		contentPane.add(btnAgregar);
		btnAgregar.setIcon(new ImageIcon("img/repartidor-2.png"));
		...
		btnCancelar.setIcon(new ImageIcon("img/cancelar3.png"));
		
		lblNewLabel = new JLabel("Agregar");
		lblNewLabel.setEnabled(false);
		lblNewLabel.setFont(new Font(FONT_NAME_T, Font.BOLD, 14));
