		...
		public void valueChanged(ListSelectionEvent event) {
	        ...
	        if (!event.getValueIsAdjusting() && tablaEmpleados.getSelectedRow() != -1) {
	        	...
	        	// Obtener los datos del renglón seleccionado
	               ...
	               /*String telefono = (String) tablaEmpleados.getValueAt(tablaEmpleados.getSelectedRow(), 2);
	               String correo = (String) tablaEmpleados.getValueAt(tablaEmpleados.getSelectedRow(), 3);*/ 
